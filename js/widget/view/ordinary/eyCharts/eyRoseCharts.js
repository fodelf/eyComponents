...
(function($,ey,echarts){
	"use strict";
    var EyRoseCharts = function(args){
    	//继承线图基类
    	...
    	this._domTemplate = $("<div class='ey-lineCharts ey-widget eyCharts eyCharts-bg-blue'>"
    						...
    						+"</div>");
    	this.widgetName = "eyRoseCharts";
    	this.lineColor = [{"full":"#209c91","empty":"rgba(32,156,145,.3)"}];
    };
    //继承组件基类
    ey.extendFun(EyRoseCharts,"eyCharts","widget");
    //扩展当前组件
    ey.expandPrototype(EyRoseCharts,{
    	//设置图例类型
...
//			$.extend(true, option, {'color':this._lineColor});
    ...
    ey.widget.eyRoseCharts = function (args){
    	return new EyRoseCharts (args);
    };
