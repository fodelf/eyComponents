...
(function($,ey,echarts){
	"use strict";
    var EyHalfDashBoard = function(args){
    	//继承线图基类
    	...
    	this._domTemplate = $("<div class='ey-lineCharts ey-widget eyCharts eyCharts-bg-blue'>"
    						...
    						+"</div>");
    	this.widgetName = "eyHalfDashBoard";
    	this.lineColor = [{"full":"#209c91","empty":"rgba(32,156,145,.3)"}];
    };
    //继承组件基类
    ey.extendFun(EyHalfDashBoard,"eyCharts","widget");
    //扩展当前组件
    ey.expandPrototype(EyHalfDashBoard,{
    	//设置图例类型
    	...
    	setLineColor:function(lineColor){
    		...
    		$.extend(true, this.option.series[0].axisLine.lineStyle, 
				{'color':[[0.8,lineColor[0].full],[1,lineColor[1].full]]});
    	},
    ...
    ey.widget.eyHalfDashBoard = function (args){
    	return new EyHalfDashBoard (args);
    };
