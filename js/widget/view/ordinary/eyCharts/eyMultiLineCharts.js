...
(function($,ey,echarts){
	"use strict";
    var EyMultiLineCharts = function(args){
    	//继承线图基类
    	...
    	this._domTemplate = $("<div class='ey-lineCharts ey-widget eyCharts eyCharts-bg-blue'>"
    						...
    						+"</div>");
    	this.widgetName = "eyMultiLineCharts";
    	this._lineCount = 10;
    };
    //继承组件基类
    ey.extendFun(EyMultiLineCharts,"eyCharts","widget");
    //扩展当前组件
    ey.expandPrototype(EyMultiLineCharts,{
    	//每个图形必须重写此方法
    	getOption : function(){
			//清除无用数据只保留样式 非常重要-------------
...
//    	},
		            ...
		            label:{
						normal:{
							...
							textStyle:{
				                ...
				                color:this.labelFontColor[0].full
				            },
							formatter:'{c}'
						}
					}
    ...
    ey.widget.eyMultiLineCharts = function (args){
    	return new EyMultiLineCharts (args);
    };
