...
//	"use strict";
    var EyHeatMap = function(args){
    	...
    	this._domTemplate = $("<div class='ey-lineCharts ey-widget eyCharts eyCharts-bg-blue'>"
    						...
    						//图形内容区域
    						+"<h5></h5><div class='ey-mapContent' id='heatMap'></div>"    						
    						+"</div>");
    	this.widgetName = "eyHeatMap";
    	this.lineColor = [{"full":"#209c91","empty":"rgba(32,156,145,.3)"}];
    	
    };
    //继承组件基类
    ey.extendFun(EyHeatMap,"eyBridge","widget");
    //扩展当前组件
    ey.expandPrototype(EyHeatMap,{
    ...
    ey.widget.eyHeatMap = function (args){
    	return new EyHeatMap (args);
    };
