...
(function($,ey,echarts){
    ...
    var EyAreaMap = function(args){
    	...
    	this._domTemplate = $("<div class='ey-lineCharts ey-widget eyCharts eyCharts-bg-blue'>"
    						...
    						+"</div>");
    	this.widgetName = "eyAreaMap";
    	this.lineColor = [{"full":"#209c91","empty":"rgba(32,156,145,.3)"}];
    };
    //继承组件基类
    ey.extendFun(EyAreaMap,"eyCharts","widget");
    //扩展当前组件
    ey.expandPrototype(EyAreaMap,{
    ...
    ey.widget.eyAreaMap = function (args){
    	return new EyAreaMap (args);
    };
