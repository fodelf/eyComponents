...
(function($,ey,echarts){
	"use strict";
    var EyStackColumnCharts = function(args){
    	//继承线图基类
    ...
    //继承组件基类
    ey.extendFun(EyStackColumnCharts,"eyCharts","widget");
    //扩展当前组件
    ey.expandPrototype(EyStackColumnCharts,{
    	//每个图形必须重写此方法
    	getOption : function(){
			//清除无用数据只保留样式 非常重要-------------
...
//  		alert(this.lineColor);
    ...
    ey.widget.eyStackColumnCharts = function (args){
    	return new EyStackColumnCharts (args);
    };
